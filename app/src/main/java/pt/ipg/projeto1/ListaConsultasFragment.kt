...
class ListaConsultasFragment: Fragment(), LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private var adapterLivros : AdapterConsultas? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapterLivros = AdapterConsultas(this)
        binding.recyclerViewConsultas.adapter = adapterLivros
        binding.recyclerViewConsultas.layoutManager = LinearLayoutManager(requireContext())
