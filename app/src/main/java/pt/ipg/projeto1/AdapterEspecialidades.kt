...
class AdapterEspecialidades(val fragment: ListaEspecialidadesFragment) : RecyclerView.Adapter<AdapterEspecialidades.ViewHolderEspecialidade>() {
    ...
    inner class ViewHolderEspecialidade(itemEspecialidades: View) : RecyclerView.ViewHolder(itemEspecialidades), View.OnClickListener {
        ...
        var especialidade : Especialidades? = null
        get() = field
        set(value: Especialidades?){
            field = value

            textViewTipoEspecialidades.text = especialidade?.tipoEspecialidades ?: ""
        }
