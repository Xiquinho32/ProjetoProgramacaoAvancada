...
class AdapterMedicos(val fragment: ListaMedicosFragment): RecyclerView.Adapter<AdapterMedicos.ViewHolderMedico>(){
    ...
    var viewHolderSelecionado : ViewHolderMedico? = null
    ...
    var medico : Medicos? = null
        get() = field
        set(value: Medicos?) {
            field = value

            textViewNome.text = medico?.nome ?: ""
            textViewCartaoCidadao.text = medico?.cc ?: ""
            textViewEspecialidades.text = medico?.especialidades?.tipoEspecialidades ?: ""
        }
